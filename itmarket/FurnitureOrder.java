...
String furnitureCode;
    ...
    @Override
    void validateOrder() {
    if(!((chipFromCity=="Киев")||(chipFromCity=="Львов"))){ System.out.println("Доставка из города " + chipFromCity + " невозможна");}
    ...
    @Override
    void calculatePrice() {if (basePrice>=5000){totalPrice = basePrice*1.02;}else{totalPrice = basePrice*1.05;}
    }
}
